        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link href="/" className="inline-block" aria-label="Cruip">
                  <img src="/images/logo.jpg" alt="Cruip Logo" className="w-100 h-20 fill-current text-purple-600" />

                </Link>
              </div>
              <div className="text-gray-400">BLABLABLABLABLA MASIH GATAU TULIS APA</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">TIM</h6>
                <ul>
                  <li className="mb-1">
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">SCARLETT RANGERS</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/lakiscarlett" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">SCARLETT BOYS</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/cewescarlett " className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">SCARLETT GIRLS</Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              {/* <li>
                <Link href="/" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Tiktok">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy;TIM SCARLETT HOUSE</div>
